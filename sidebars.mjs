      ...
      items: [
        {
          ...
          label: 'Customer Web',
          items: [
            {type: 'doc', id: 'uiux/SWIDA_UIUX_Spec_Customer_Web_EN', label: 'English'},
            {type: 'doc', id: 'uiux/SWIDA_UIUX_Spec_Customer_Web_KO', label: '한국어'},
          ],
        },
        {
          type: 'category',
          label: 'Admin Web',
          items: [
            {type: 'doc', id: 'uiux/SWIDA_UIUX_Spec_Admin_Web_EN', label: 'English'},
            {type: 'doc', id: 'uiux/SWIDA_UIUX_Spec_Admin_Web_KO', label: '한국어'},
          ],
        },
      ],
    },
